...
public class RecentGames {
    /**
     * Instantiates a new Recent games.
     *
     * @param lobbies the lobbies
     */
    public RecentGames(List<RecentGame> lobbies) {
    ...
    /**
     * Builder recent games . recent games builder base.
     *
     * @return the recent games . recent games builder base
     */
    ...
    public static class RecentGamesBuilder
        ...
        /**
         * Instantiates a new Recent games builder.
         */
    ...
    /**
     * The type Recent games builder base.
     *
    ...
    public static abstract class RecentGamesBuilderBase<T extends RecentGames> {
        ...
        /**
         * Instantiates a new Recent games builder base.
         */
        ...
        /**
         * With recent games recent games . recent games builder base.
         *
         * @param recentGames the recent games
         * @return the recent games . recent games builder base
         */
