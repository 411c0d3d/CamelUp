...
public class StartGame implements Serializable {
     ...
     */
    public static StartGame.StartGameBuilderBase builder() {
        return new StartGame.StartGameBuilder();
    }
    ...
    public static class StartGameBuilder
            extends StartGame.StartGameBuilderBase<StartGame> {
        /**
    ...
    public static abstract class StartGameBuilderBase<T extends StartGame> {
        ...
        public StartGameBuilderBase() {
            ...
            if (this.getClass().equals(StartGame.StartGameBuilder.class)) {
