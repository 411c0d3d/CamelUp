...
public class GameConfig {
    ...
    @Valid
    @NotNull
    private transient List<Camel> camels = new ArrayList<>();

    private int camelCount = 0;
    /**
    ...
    public String toString() {
        ...
        sb.append('=');
        sb.append(((this.illegalMovePenalty == null) ? "<null>" : this.illegalMovePenalty.getValue()));
        sb.append(',');
...
//        }
        ...
        public static GameConfig.IllegalMovePenalty fromValue(String value) {
            for (IllegalMovePenalty penalty : IllegalMovePenalty.values()) {
                if (penalty.value.equalsIgnoreCase(value)) {
                    return penalty;
                }
            }
            System.err.println("\"Unknown penalty:" + value);
            return null;
        }
    }
