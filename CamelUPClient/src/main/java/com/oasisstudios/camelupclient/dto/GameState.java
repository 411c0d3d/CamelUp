...
public class GameState {
    ...
    public String toString() {
        ...
        sb.append("gamePhase");
        sb.append('=');
        sb.append(((this.gamePhase == null) ? "<null>" : this.gamePhase));
        sb.append(',');
    ...
    public enum GamePhase {
        ...
        /**
         * From value game state . game phase.
         *
         * @param value the value
         * @return the game state . game phase
         */
        public static GameState.GamePhase fromValue(String value) {
            GameState.GamePhase constant = CONSTANTS.get(value);
            if (constant == null) {
