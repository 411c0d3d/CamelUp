...
import com.oasisstudios.camelupclient.gui.components.CircularIconWidget;
import com.oasisstudios.camelupclient.gui.components.Clickable;
...
public class MainMenuView extends AbstractSceneBasedView {
    ...
    private void styleComponents() {
        ...
        camelUpLogoView.setFitHeight(225);
    ...
    private void configureLayouts() {
        ...
        var spectatorRole = new Clickable(new CircularIconWidget(spectatorLabel, spectateImage, 40, "#593B3B"));
        spectatorRole.setOnClick(e -> onClicked(UserType.SPECTATOR));

        // Boxen für Rollen erstellen
        configureRoleBox(spectatorBox, spectatorRole, spectatorLabel);
    ...
    void onClicked(UserType userType) {
        ...
        switch (userType) {
            case SPECTATOR:
                //guiApplication.showScene(new SpectatorView(this.getPrimaryStage()));
                view = new GamesSelectionView(this.getPrimaryStage());
