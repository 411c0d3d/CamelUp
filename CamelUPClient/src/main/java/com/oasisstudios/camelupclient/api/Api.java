package com.oasisstudios.camelupclient.api;


import com.google.gson.Gson;
import com.oasisstudios.camelupclient.dto.*;
import com.oasisstudios.camelupclient.gui.components.ConnectionStatusWidget;
...
import static com.oasisstudios.camelupclient.dto.Packet.Type.*;
...
public class Api {
    ...
    public CompletableFuture<RegisteredPlayerList> listPlayers() {
        logger.trace("--> Listing players...");
        var future = new CompletableFuture<RegisteredPlayerList>();
        addPendingObjectRequest(RegisteredPlayerList.class, future);
        client.sendMessage(Packet.builder()
                .withType(Packet.Type.REGISTERED_PLAYERS)
                .build());
    ...
    public void setMessageListener(ConnectionStatusWidget connectionStatusWidget) {
    }
}
